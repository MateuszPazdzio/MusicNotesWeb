...
- Create Angular project with ng: `ng new musicnotesweb.client --defaults --skip-install --skip-git --no-standalone `.
...
- Create project file (`musicnotesweb.client.esproj`).
